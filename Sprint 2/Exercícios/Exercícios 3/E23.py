...
chamados de operadores e operandos. Em operadores, espera-se uma
lista de caracteres que representam as operações matemáticas
...
def calcular_valor_maximo(operadores, operandos):
    ...
    resultados = map(lambda value: operacao(value[0], value[1][0], value[1][1]), zip(operadores, operandos))
